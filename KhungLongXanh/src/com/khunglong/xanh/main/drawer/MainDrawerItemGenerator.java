...
public class MainDrawerItemGenerator implements
	...
	public List<DrawerItem<?>> generateMain() {
		...
		// hanhphucgiobay
		// nghiemtuc VL
		list.add(new PageChangeDrawerItem(R.drawable.haivl,
...
//		        R.array.page4)[0])));
		...
		// page 4
				list.add(new PageChangeDrawerItem(R.drawable.nghiemtucvl, context.getResources().getStringArray(
				        R.array.page4)[1], "help", "help", context.getResources().getStringArray(
				        R.array.page4)[0]));

				// page 5
				list.add(new PageChangeDrawerItem(R.drawable.hanhphucgiobay, context.getResources().getStringArray(
				        R.array.page5)[1], "help", "help", context.getResources().getStringArray(
				        R.array.page5)[0]));
