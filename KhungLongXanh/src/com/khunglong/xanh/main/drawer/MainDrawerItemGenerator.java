...
public class MainDrawerItemGenerator implements DrawerItemGenerator<DrawerItem<?>> {
	...
	public List<DrawerItem<?>> generateMain() {
		...
		// hanhphucgiobay
		// nghiemtuc VL
		list.add(new PageChangeDrawerItem(R.drawable.haivl, context.getResources().getStringArray(R.array.page3)[1],
				"help", "help", context.getResources().getStringArray(R.array.page3)[0]));
		...
		list.add(new PageChangeDrawerItem(R.drawable.nghiemtucvl,
				context.getResources().getStringArray(R.array.page4)[1], "help", "help", context.getResources()
						.getStringArray(R.array.page4)[0]));

		// page 5
		list.add(new PageChangeDrawerItem(R.drawable.hanhphucgiobay, context.getResources().getStringArray(
		...
		list.add(new FragmentChangeDrawerItem(R.drawable.save, "save", "save", "save", new SaveFragment()));
		return list;
	}
