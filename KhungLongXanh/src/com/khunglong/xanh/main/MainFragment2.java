...
public class MainFragment2 extends BaseFragment implements OnPageChangeListener, OnBackPressListener {
	...
	public static interface IMainFragmentListener {
		void onIMainFragmentStart(MainFragment2 f, int i, BaseObject link);

		void onMainFragmentPageSelected(MainFragment2 main, Fragment selected, BaseObject link);

		void onMainFragmentPageDeSelected(MainFragment2 main, Fragment selected, BaseObject link);
	}
	...
	public static MainFragment2 newInstance(String page) {
...
//		}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = (ViewGroup) inflater.inflate(R.layout.main_fragment2, container, false);
		context = getActivity().getApplicationContext();
		...
		mViewPager = (InfiniteViewPager) rootView.findViewById(R.id.pager2);
		...
		if (listener != null) {
			listener.onIMainFragmentStart(MainFragment2.this, 10, null);
		}
