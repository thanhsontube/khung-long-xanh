                    ...
                    public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                        ...
                        try {
                            ...
                            Toast.makeText(SingleTouchImageViewActivity.this,
                                    "Your image is saved to this folder:" + f.toString(), Toast.LENGTH_LONG).show();
                        } catch (Exception e) {
                            Log.e("", "log>>>" + "error save Image:" + e.toString());
                            Toast.makeText(SingleTouchImageViewActivity.this, "Error save Imager", Toast.LENGTH_LONG)
                                    .show();
                        }
