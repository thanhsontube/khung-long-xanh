...
public class MainFragment5 extends BaseFragment implements OnPageChangeListener, OnBackPressListener {
	...
	public static interface IMainFragmentListener {
		void onIMainFragmentStart(MainFragment5 f, int i, BaseObject link);

		void onMainFragmentPageSelected(MainFragment5 main, Fragment selected, BaseObject link);

		void onMainFragmentPageDeSelected(MainFragment5 main, Fragment selected, BaseObject link);
	}
	...
	public static MainFragment5 newInstance(String page) {
		MainFragment5 f = new MainFragment5();
...
//		}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (listener != null) {
			listener.onIMainFragmentStart(MainFragment5.this, 10, null);
		}
