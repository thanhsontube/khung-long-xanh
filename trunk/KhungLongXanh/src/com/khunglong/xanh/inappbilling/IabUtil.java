...
package com.khunglong.xanh.inappbilling;
...
public class IabUtil {
    ...
    public static void showBeer(Activity activity, IabHelper helper) {
        ...
        new PurchaseDialog().show(ft, "dialog_purchase");
    }
    ...
    public static class PurchaseDialog extends DialogFragment {
        ...
        public PurchaseDialog() {
            if (mHelper == null && getActivity() != null)
                mHelper = ((MyLoginActivity) getActivity()).getHelper();
        };
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            TextView nameAndVersionView = (TextView) rootView.findViewById(R.id.purchase_app_name_and_version);
            nameAndVersionView.setText(Html.fromHtml(getString(R.string.demo_purchase)));
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setView(rootView)
                    .setPositiveButton(R.string.purchase_cancel, new DialogInterface.OnClickListener() {
